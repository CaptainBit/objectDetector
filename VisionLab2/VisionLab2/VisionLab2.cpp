...
int main()
{
	...
	Mat hsv_image,mask, mask1, mask2, mask3;

	
	Mat picture = imread("trafficlight.jpg", 1);
	Mat pictureOrig = imread("trafficlight.jpg", 1);
	...
	inRange(hsv_image, Scalar(20, 100, 100), Scalar(30, 255, 255), mask1);
	inRange(hsv_image, Scalar(0, 100, 100), Scalar(10, 255, 255), mask2);
